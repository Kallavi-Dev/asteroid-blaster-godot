...
func _apply_visual() -> void:
	match power_type:
		Constants.PowerUpType.SHIELD:
			_sprite.texture = load("res://assets/sprites/powerups/powerupGreen_shield.png")
		Constants.PowerUpType.RAPID_FIRE:
			_sprite.texture = load("res://assets/sprites/powerups/powerupRed_bolt.png")
		Constants.PowerUpType.SPREAD_SHOT:
			_sprite.texture = load("res://assets/sprites/powerups/powerupBlue_star.png")
